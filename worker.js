...
function unusualSignal(v){
  ...
  if(Math.abs(p5)>=4){s+=25;why.push("movimiento 5D ≥4%")}else if(Math.abs(p5)>=2){s+=15;why.push("movimiento 5D ≥2%")}
  if(dv>=2){s+=20;why.push("$ volumen ≥2x promedio")}else if(dv>=1.5){s+=10;why.push("$ volumen ≥1.5x promedio")}
